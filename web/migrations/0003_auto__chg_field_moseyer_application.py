...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Moseyer.application'
        db.alter_column(u'web_moseyer', 'application', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Moseyer.application'
        db.alter_column(u'web_moseyer', 'application', self.gf('django.db.models.fields.files.FileField')(max_length=100))
