...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MoseyerComment'
        db.create_table(u'web_moseyercomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('moseyer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Moseyer'])),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=2048)),
        ))
        db.send_create_signal(u'web', ['MoseyerComment'])


    def backwards(self, orm):
        # Deleting model 'MoseyerComment'
        db.delete_table(u'web_moseyercomment')
