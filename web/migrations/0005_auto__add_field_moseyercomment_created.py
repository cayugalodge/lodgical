...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MoseyerComment.created'
        db.add_column(u'web_moseyercomment', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 2, 3, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MoseyerComment.created'
        db.delete_column(u'web_moseyercomment', 'created')
    ...
    models = {
        ...
        u'web.moseyer': {
            ...
            'application': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
        ...
        u'web.moseyercomment': {
            'Meta': {'object_name': 'MoseyerComment'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moseyer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Moseyer']"}),
