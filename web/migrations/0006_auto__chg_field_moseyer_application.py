...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'web_moseyer', 'application', self.gf('django.db.models.fields.CharField')(max_length=10000))
    ...
    models = {
        ...
        u'web.moseyer': {
            ...
            'application': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10000', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
